...
class PaymentController extends Controller
{
    ...
    public function payWithStripe(Request $request){
        ...
        $payableAmount = round($calculate_amount['total_amount'] * $stripe->currency_rate, 2);
    ...
    public function mollie_webview(Request $request){
        ...
        $mollie = PaystackAndMollie::first();
        $price = $calculate_amount['total_amount'] * $mollie->mollie_currency_rate;
        $price = round($price,2);
    ...
    public function instamojo_webview(Request $request){
        ...
        $price = $calculate_amount['total_amount'] * $instamojoPayment->currency_rate;
        $price = round($price,2);
