                ...
                <div class="col-xl-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{__('user.Product details')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-xl-8 col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    ...
                    <div class="wsus__product_details_text">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="javascript:;" class="text-secondary add_wishlist" onclick="addWishlist({{ $product->id }})"><i class="far fa-heart"></i> {{__('user.Add Wishlist')}}</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="wsus__pro_det_comment mt_50">
                                    ...
                                    <div class="wsus__single_comment">
                                        <p class="comment_date">{{ Carbon\Carbon::parse($productComment->created_at)->format('F d,Y') }} {{__('user.At')}} {{  Carbon\Carbon::parse($productComment->created_at)->format('h:i A') }}</p>
                                        <p class="comment_des">
                                        ...
                                        <div class="comment_footer d-flex flex-wrap mt-4">
                                            ...
                                            <div class="text">
                                                <h3>{{ html_decode($productComment->user->name) }}</h3>
                                                <p>{{ html_decode($productComment->user->address) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                                ...
                                <div class="wsus__pro_det_review mt_50">
                                    ...
                                    <div class="wsus__single_comment">
                                        ...
                                        <p class="comment_date user-product-review">
                                            ...
                                            {{ Carbon\Carbon::parse($productReview->created_at)->format('F d,Y') }} {{__('user.At')}} {{  Carbon\Carbon::parse($productReview->created_at)->format('h:i A') }}
                                        </p>
                        ...
                        <div class="wsus__sidebar_licence">
                            ...
                            <div class="select_licance">
                                <select class="select_js" name="price_type" id="price_type">
                                    <option value="regular price">{{__('user.Ragular price')}}</option>
                            ...
                            @else
                                <input type="hidden" value="{{ $product->admin_author->name }}" id="author_name">
                                <input type="hidden" value="{{ $product->admin_author->id }}" id="author_id">
                            @endif




                            <a class="live mt-3" target="__blank" href="{{ $product->preview_link }}">{{__('user.Live Preview')}}</a>
                            <a class="common_btn" href="javascript:;" onclick="addToCard({{ $product->id }})">{{__('user.Add to cart')}}</a>
                        </div>

                        <div class="wsus__sidebar_buy_info mt_30">
                            <h3>{{__('user.Buying Info')}}</h3>
                            <ul class="info">
                                <li>
                                ...
                                <li>
                                    <p><i class="far fa-comments"></i> {{__('user.Comments')}}</p>
                                    <span>{{ $productComments->count() }}</span>
                                </li>
                                <li>
                                    <p><i class="far fa-star"></i> {{__('user.Item Rating')}}</p>
                                ...
                                <div class="wsus__sidebar_author_info mt_30">
                                    ...
                                    <div class="wsus__sidebar_author_text d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="text">
                                            ...
                                            <p>{{__('user.Member Since')}} - {{ Carbon\Carbon::parse($product->author->created_at)->format('F Y') }}</p>
                                        </div>
                                    </div>
                                    <ul class="d-flex flex-wrap justify-content-center">
                                        <li><a class="common_btn view_profile" href="{{ route('author-profile', $product->author->user_name ) }}">{{__('user.View Profile')}}</a></li>
                                        @if (Auth::guard('web')->check())
                                        <li><a class="common_btn" href="javascript:;" data-bs-toggle="modal"
                                            data-bs-target="#messageModal">{{__('user.Send Message')}}</a></li>
                                        @else
                                        <li><a class="common_btn" href="javascript:;" id="send_message_btn">{{__('user.Send Message')}}</a></li>
                                        @endif
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="wsus__gallery_item">
                        <div class="wsus__gallery_item_img">
                            ...
                            <ul class="wsus__gallery_item_overlay">
                                <li><a href="{{ $product->preview_link }}">{{__('user.Preview')}}</a></li>
                ...
                <div class="col-12 text-center text-danger mt-5">
                    <h2 class="mt-5">{{__('user.Related product Not Found')}}</h2>
                </div>
                @endforelse
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">{{__('user.Contact Author')}}</h1>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 mt-2">
                                        <ul class="d-flex flex-wrap">
                                            ...
                                            <li>
                                                <button type="submit" class="common_btn" id="submitBtnn">{{__('user.Send Message')}}</button>
