    ...
    <nav class="navbar navbar-expand-lg main_menu main_menu_2">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset($setting->logo_two) }}" alt="Degmark" class="img-fluid w-100">
            </a>
...
@yield('frontend-content')
    ...
    <!--=============================
        FOOTER START
    ==============================-->
    <footer class="footer_2 mt_100" style="background: url( {{asset('frontend/images/footer_bg2.png')}});">
        <div class="container">
            <div class="row">
                <div class="col-12 wow fadeInUp" data-wow-duration="1s">
                    <div class="wsus__subscribe mt_90">
                        <div class="row">
                            <div class="col-xl-6 col-lg-9 m-auto">
                                @php
                ...
                <div class="col-xl-2 col-md-4">
                    <div class="wsus__footer_content">
                        <a class="footer_logo" href="index.html">
                            <img src="{{ asset($setting->footer_logo_two) }}" alt="degmark" class="img-fluid w-100">
                        </a>
                        <ul>
                            @if ($setting->vendor_type == 'multi')
