            ...
            <div class="row mt_5">
                <div class="col-xl-6">
                    <div class="wsus__current_balance">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#withdraw_modal">{{__('user.Withdraw')}}</a>
                    </div>
                </div>
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="status"><span class="pending">{{__('user.Success')}}</span></td>
                                        @else
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('withdraw.store') }}" method="POST">
                                            ...
                                            <div class="withdraw_modal_input">
                                                <label>{{__('user.Select Withdraw Method')}}*</label>
                                            ...
                                            <div class="withdraw_modal_input mt-3">
                                                <label>{{__('user.Withdraw amount')}}*</label>
                                                <input type="text" name="withdraw_amount">
                                            </div>
                                            <div class="withdraw_modal_input">
                                                <label>{{__('user.Account Information')}}*</label>
                                                <textarea name="account_info" id="" cols="30" rows="10"></textarea>
                                            </div>
                                            <button type="submit" class="common_btn">{{__('user.Withdrow Now')}}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
