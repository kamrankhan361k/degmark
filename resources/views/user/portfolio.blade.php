                            ...
                            <div class="col-xl-6 col-md-6 wow fadeInUp" data-wow-duration="1s">
                                <div class="wsus__gallery_item">
                                    ...
                                    <div class="wsus__gallery_item_text">
                                        <p>{{__('user.By')}} <span>{{ $product->author->name }}</span> {{__('user.In')}} <a class="category" href="{{ route('products', ['category' => $product->category->slug]) }}">{{ $product->category->name }}</a></p>
                                        ...
                                        <ul class="d-flex flex-wrap justify-content-between">
                                            ...
                                            @endphp
                                            <li><a href="#"><i class="fas fa-download"></i> {{ $sale }} {{__('user.Sale')}}</a></li>
                                            <li>
                                                <p>
