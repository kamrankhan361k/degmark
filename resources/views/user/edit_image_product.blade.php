            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="variant_price">
                        ...
                        <a class="common_btn" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">{{__('user.Add New
                            Variant &
                            Price')}}</a>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="variant_price variant_price_2">
                        <h4>{{__('user.Variant and Price')}}</h4>
                        <a href="#" class="common_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">{{__('user.Add
                            More Variant')}}</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="button_area">
                                            <a href="{{ route('admin.download-existing-file', $product_variant->file_name) }}" class="download_btn"><i class="fad fa-arrow-to-bottom"></i>
                                                {{__('user.download')}}</a>
                                            <a href="#"  data-bs-toggle="modal" data-bs-target="#editVariantModal-{{ $product_variant->id }}" class="edit_btn"><i class="fas fa-edit"></i> {{__('user.edit')}}</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('store-product-variant', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label>{{__('user.Upload Image')}}*</label>
