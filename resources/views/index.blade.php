...
@section('frontend-content')
    ...
    <section class="wsus__banner">
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-md-10 m-auto">
                    <div class="wsus__banner_text wow fadeInUp" data-wow-duration="1s">
                        <h1>{{ $intro_section->content->home1_title  }}</h1>
                        <p>{{ $intro_section->content->home1_description  }}</p>
                        ...
                        <ul class="wsus__banner_counter d-flex flex-wrap justify-content-center mt_20">
                            <li>
        ...
        <div class="background_animi_area">
            <ul class="bg_animation">
                ...
                <li class="wow bounceIn" data-wow-duration=" 2100ms"></li>
                <li class="wow bounceIn" data-wow-duration=" 2200ms"></li>
            </ul>
            <ul class="bg_animation bg_animation_r d-none d-md-block">
                <li class="wow bounceIn" data-wow-duration=" 1000ms"></li>
                <li class="wow bounceIn" data-wow-duration=" 1100ms"></li>
                <li class="wow bounceIn" data-wow-duration=" 1200ms"></li>
                <li class="wow bounceIn" data-wow-duration=" 1300ms"></li>
   ...
   @if ($category_visibility)
    <section class="wsus__categories pt_95 pb_100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8 m-auto wow fadeInUp" data-wow-duration="1s">
            ...
            <div class="row wow fadeInUp" data-wow-duration="1s">
                ...
                <div class="col-xl-2 col-6 col-md-4 col-lg-3">
                    <div class="wsus__categories_item">
                        <div class="icon">
                            <img src="{{ asset($category->icon) }}" alt="{{ $category->name }}" class="img-fluid w-100">
                        </div>
                        <h3>{{ $category->name }}</h3>
   ...
   @endif
    ...
    ==============================-->
      ...
      <section class="wsus__offer" style="background: url( {{asset($special_offer->home1_background)}});">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-5 wow fadeInLeft" data-wow-duration="1s">
                    <div class="wsus__offer_text">
                        <p>{{ $special_offer->title1 }}</p>
                        <h2>{{ $special_offer->title2 }}</h2>
                        <a target="_blank" class="common_btn" href="{{ $special_offer->link }}">{{__('user.Go to Offer page')}}</a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-5 wow bounceIn" data-wow-duration="1s">
                    <div class="wsus__offer_img">
                        <img src="{{ asset($special_offer->home1_foreground1) }}" alt="offer" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="wsus__why_choose pt_95 pb_100" style="background: url( {{asset($why_choose_us->home1_background)}});">
        <div class="container">
            <div class="row">
                    ...
                    <div class="wsus__testimonial_item">
                        ...
                        <div class="wsus__testimonial_footer d-flex flex-wrap">
                            ...
                            <div class="text">
                                ...
                                <p>{!! clean($testimonial->designation) !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
