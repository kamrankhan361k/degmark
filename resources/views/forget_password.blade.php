                        ...
                        <form action="{{ route('send-forget-password') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 mt-2">
                                    <button class="common_btn" type="submit">{{__('user.Forget Your Password')}}</button>
                                </div>
                                <div class="col-xl-12">
                                    <p class="go_login">{{__('user.Redirect to login page')}}.  <a href="{{ route('login') }}">{{__('user.Click here')}}</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
