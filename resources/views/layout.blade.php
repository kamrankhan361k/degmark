            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__header_content d-flex flex-wrap justify-content-between">
                        ...
                        <ul class="wsus__header_right d-flex flex-wrap d-none d-md-flex">
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset($setting->logo) }}" alt="Degmark" class="img-fluid w-100">
            </a>
                ...
                <ul class="right_menu d-flex flex-wrap">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}">
                            <img src="{{ asset('frontend') }}/images/menu_user_icon.png" alt="user" class="img-fluid w-100">
                        </a>
                        <ul class="wsus__droap_menu">
            ...
            <div class="row">
                <div class="col-12 wow fadeInUp" data-wow-duration="1s">
                    @php
                        ...
                        $setting = App\Models\Setting::first();
                    @endphp
                    <div class="wsus__subscribe" style="background: url({{ asset('frontend/images/subscribe_bg.jpg') }});">
                        <div class="row">
                            <div class="col-xxl-6 col-xl-8 col-md-8">
                                ...
                                <form id="fsubscriberForm">
                                    ...
                                    <button class="common_btn d-none" id="fsubShowSpain"><i class="fas fa-spinner fa-spin"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-md-4">
                    <div class="wsus__footer_content">
                        <a class="footer_logo" href="{{ route('home') }}">
                            <img src="{{ asset($setting->footer_logo) }}" alt="degmark" class="img-fluid w-100">
                        </a>
                        <ul>
                            @if ($setting->vendor_type == 'multi')
           ...
           success:function(data){
            if(data.total){
                $('#calprice').html(`
                    ...
                    <p class="total">Total <span><span>${data.setting.currency_icon}<span>${data.total}</span></span></p>
                ...
                $('#calprice').html(`
                    ...
                    <p class="total">Total <span>${data.setting.currency_icon}${data.total_amount}</span></p>
                    <a class="common_btn" href="{{ route('checkout') }}">{{__('user.Proceed to Checkout')}}</a>
                `);
            }
        }
