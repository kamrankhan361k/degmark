                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="database-generate-tab" data-toggle="tab" href="#databaseGenerateTab" role="tab" aria-controls="databaseGenerateTab" aria-selected="true">{{__('Database Generate')}}</a>
                                        </li>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                              <label for="">{{__('admin.Vendor Type')}}</label>
                                                              <select name="vendor_type" id="" class="form-control">
                                                                  <option {{ $setting->vendor_type == 'multi' ? 'selected' : '' }} value="multi">{{__('admin.Multi vendor')}}</option>
                                                                  <option {{ $setting->vendor_type == 'single' ? 'selected' : '' }} value="single">{{__('admin.Single vendor')}}</option>
                                                              </select>
                                                          </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-database') }}" method="POST">
                                                            ...
                                                            <button class="btn btn-primary">{{__('Update Database')}}</button>
                                                    </form>
                                                    </div>
                                                </div>
                                            </div>
