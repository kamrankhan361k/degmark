                ...
                <div class="card">
                  <div class="card-body">
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item"><a href="{{ route('admin.product.edit', $product->id) }}" class="nav-link active">{{__('admin.Basic Information')}}</a></li>
                        ...
                        <form action="{{ route('admin.image-product-update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('admin.Existing thumnail')}}</label>
                                    <div>
