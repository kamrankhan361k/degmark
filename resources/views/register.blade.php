                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__login_inpu_area">
                                        ...
                                        <input type="email"name="email" placeholder="{{__('user.example@gmail.com')}}">
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="wsus__login_inpu_area">
                                ...
                                <div class="col-xl-12 mt-2">
                                    <button class="common_btn" type="submit">{{__('user.Registration')}}</button>
                                </div>
                                <div class="col-xl-12">
                                    <p class="go_login">{{__('user.Already have Account')}}? <a href="{{ route('login') }}">{{__('user.Log In')}}</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
